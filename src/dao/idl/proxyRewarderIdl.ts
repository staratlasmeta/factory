export type ProxyRewarder = {
  ...
  instructions: [
    {
      name: 'registerLocker';
      docs: ['Registers a Locker from the locked_voter program'];
      accounts: [
        {
          name: 'admin';
          isMut: true;
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ['[locked_voter::Locker].'];
        },
        {
          name: 'registeredLocker';
          isMut: true;
          isSigner: false;
          docs: ['New RegisteredLocker account'];
          pda: {
            seeds: [
              {
                kind: 'const';
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ['The [locked_voter::locker] being exited from.'];
        },
        {
          name: 'registeredLocker';
          isMut: true;
          isSigner: false;
          docs: ['RegisteredLocker account'];
          pda: {
            seeds: [
              {
                kind: 'const';
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: true;
          docs: ['Authority of the [Proxy] to be created.'];
        },
        {
          name: 'systemProgram';
          isMut: false;
    ...
    {
      name: 'proxyLock';
      docs: ['Locks `amount` of POLIS into the [LockedVoter::Escrow].'];
      accounts: [
        {
          name: 'locker';
          isMut: true;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['Token account held by the [locked_voter::Escrow].'];
        },
        {
          name: 'proxy';
          isMut: true;
          isSigner: false;
          docs: ['Authority of the [locked_voter::escrow].'];
          pda: {
            seeds: [
              {
                kind: 'const';
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['The [locked_voter::Escrow] that is being closed.'];
        },
        {
          name: 'proxy';
          isMut: true;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['Tokens locked up in the [locked_voter::Escrow].'];
        },
        {
          name: 'proxyTokenAccount';
          isMut: true;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['Final destination for the tokens to unlock.'];
        },
        {
          name: 'payer';
          isMut: true;
    ...
    {
      name: 'proxyCastVote';
      docs: ['Proxy Activates a proposal.', 'Proxy Casts a vote.'];
      accounts: [
        {
          name: 'locker';
          isMut: false;
      ...
      accounts: [
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ['The [locked_voter::Escrow] being validated from.'];
        },
        {
          name: 'locker';
          isMut: false;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['[proxy_rewarder::proxy_escrow].'];
        },
        {
          name: 'escrowHistory';
          isMut: false;
          isSigner: false;
          docs: ['The [snapshots::escrow_history] to read and validate.'];
        },
        {
          name: 'lockerHistory';
          isMut: false;
          isSigner: false;
          docs: ['The [snapshots::locker_history] to read and validate.'];
        },
        {
          name: 'treasuryTokenAccount';
          isMut: true;
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ['The treasury authority PDA'];
          pda: {
            seeds: [
              {
                kind: 'const';
  ...
  accounts: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'escrow';
            docs: ['The [Escrow] that this [Proxy] is part of.'];
            type: 'publicKey';
          },
          {
            name: 'owner';
          ...
          {
            name: 'proxyTokenAccount';
            docs: ['The token account holding the proxy tokens.'];
            type: 'publicKey';
          }
        ];
      };
    ...
    {
      name: 'ProxyEscrow';
      docs: ['records rewards state on a user.'];
      type: {
        kind: 'struct';
        fields: [
          {
